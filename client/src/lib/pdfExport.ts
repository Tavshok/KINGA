...
export async function generateComparisonPDF(data: ClaimData, currencySymbol: string = 'US$'): Promise<void> {
  ...
  const sigNote = 'This report has been generated by the KINGA system and is subject to review and authorisation by a qualified assessor. By signing below, the assessor confirms the accuracy of the AI-generated findings and takes responsibility for the final assessment decision.';
...
export async function generateDamageReportPDF(data: {
  ...
  doc.setFontSize(9);
  doc.setTextColor(80, 80, 80);
  const dmgSigNote = 'This damage analysis report has been generated by the KINGA system. By signing below, the assessor confirms review of the AI-generated damage findings and accepts responsibility for the final assessment decision.';
