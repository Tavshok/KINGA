/**
 * PURPOSE: Render the Reports Centre route and coordinate its role-specific KINGA client experience.
...
function GenerateDialog({
  ...
  const [resolvedClaim, setResolvedClaim] = useState<{
    ...
    vehicleRegistration?: string; vehicleMake?: string; vehicleModel?: string; kingaRef?: string;
  } | null>(null);
            ...
            {resolvedClaim ? (
              ...
              <div className="flex items-center gap-2 p-2 bg-gray-50 border border-gray-200 rounded-md">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  {resolvedClaim.kingaRef && (
                    <p className="text-xs font-mono" style={{ color: '#6366f1', fontWeight: 700, letterSpacing: '0.04em' }}>
                      {resolvedClaim.kingaRef}-CL &nbsp;/&nbsp; {resolvedClaim.kingaRef}-FR
                    </p>
                  )}
                    ...
                    {(lookupResults as any[]).map((c: any) => (
                      ...
                      >
                        ...
                        <div className="min-w-0">
                          ...
                          {(c as any).kingaRef && (
                            <p className="text-xs font-mono" style={{ color: '#6366f1', fontWeight: 600, letterSpacing: '0.03em' }}>{(c as any).kingaRef}</p>
                          )}
                          <p className="text-xs text-gray-500 truncate">
