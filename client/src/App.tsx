...
const ExternalAssessorWorkspace = lazy(() => import("./pages/ExternalAssessorWorkspace"));
...
const AssessorReportReviewQueue = lazy(() => import("./pages/AssessorReportReviewQueue"));
    ...
    <Suspense fallback={<PageLoader />}>
      <Switch>
        ...
        <Route path="/user-diagnostic">
          <ProtectedRoute allowedRoles={["user", "admin", "insurer", "assessor", "panel_beater", "claimant", "platform_super_admin"]}>
            <UserDiagnostic />
          </ProtectedRoute>
        </Route>
        ...
        <Route path="/insurer-portal/external-assessor/claims/:id">
          <ProtectedRoute allowedRoles={["insurer", "admin", "platform_super_admin"]}>
            <RoleGuard allowedRoles={["assessor_external"]}>
              <InsurerPortalLayout><AssessorClaimDetails routePattern="/insurer-portal/external-assessor/claims/:id" dashboardPath="/insurer-portal/external-assessor" /></InsurerPortalLayout>
            </RoleGuard>
          </ProtectedRoute>
        </Route>

        <Route path="/insurer-portal/external-assessor">
          <ProtectedRoute allowedRoles={["insurer", "admin", "platform_super_admin"]}>
            <RoleGuard allowedRoles={["assessor_external"]}>
              <InsurerPortalLayout><ExternalAssessorWorkspace /></InsurerPortalLayout>
            </RoleGuard>
          </ProtectedRoute>
        </Route>
        ...
        <Route path="/insurer-portal/assessor-report-reviews">
          <ProtectedRoute allowedRoles={["insurer", "admin", "platform_super_admin"]}>
            <RoleGuard allowedRoles={["claims_assessor", "claims_manager", "insurer_admin"]}>
              <InsurerPortalLayout><AssessorReportReviewQueue /></InsurerPortalLayout>
            </RoleGuard>
          </ProtectedRoute>
        </Route>
