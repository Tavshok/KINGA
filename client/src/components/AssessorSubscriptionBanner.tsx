...
export function AssessorSubscriptionBanner() {
  ...
  if (tier === "pro" && !isExpired) {
    return (
      <div className="flex items-center gap-3 px-4 py-2 rounded-lg bg-green-50 dark:bg-green-950/30 border border-green-200 dark:border-green-800 mb-4">
        <CheckCircle2 className="h-4 w-4 text-green-600 shrink-0" />
        <div className="flex-1 min-w-0">
          <span className="text-sm font-medium text-green-800 dark:text-green-200">Pro Plan</span>
  ...
  if (isCapReached) {
    return (
      <div className="rounded-lg bg-red-50 dark:bg-red-950/30 border-2 border-red-300 dark:border-red-700 px-4 py-3 mb-4">
  ...
  if (isLow) {
    return (
      <div className="rounded-lg bg-amber-50 dark:bg-amber-950/30 border border-amber-300 dark:border-amber-700 px-4 py-3 mb-4">
        <div className="flex items-center gap-3">
          ...
          <div className="flex-1 min-w-0">
            ...
            <Progress value={usagePct} className="h-1.5 mt-1.5 bg-amber-100 dark:bg-amber-900/30 [&>div]:bg-amber-500" />
          ...
          <Button
            size="sm"
            variant="outline"
            className="gap-1.5 border-amber-400 text-amber-700 dark:text-amber-300 hover:bg-amber-100 dark:bg-amber-900/30 shrink-0"
            onClick={() => toast.info("Upgrade to Pro — contact your platform administrator or visit the billing portal.", { duration: 6000 })}
          >
