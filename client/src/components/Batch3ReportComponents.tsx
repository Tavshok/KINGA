/**
 * Batch 3 Report Components — KINGA v4.2
 *
 * Components:
    ...
    >
      ...
      <div style={{ display: "flex", alignItems: "center", gap: "6px" }}>
        {onReRun && (
          ...
          >
            {reRunPending ? "⟳ Running…" : "⟳ Re-run KINGA"}
          </button>
        )}
        <button
          onClick={handlePrint}
  ...
  return (
    ...
    >
      ...
      <p style={{ fontSize: "9px", color: "var(--muted-foreground)", margin: 0, lineHeight: 1.5 }}>
        This report was generated by the KINGA engine (v4.2) and is intended
