        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3">
            ...
            <Tooltip>
              <TooltipTrigger asChild>
                <div className="flex items-center gap-2 p-2 rounded-md bg-muted/50">
                  <Shield className={`h-4 w-4 ${fraudDetectionActive ? "text-green-600" : "text-gray-600 dark:text-gray-400 dark:text-muted-foreground/70"}`} />
          ...
          <TooltipProvider>
            <Tooltip>
              <TooltipTrigger asChild>
                <div className="flex items-center gap-2 p-2 rounded-md bg-muted/50">
                  <Activity className={`h-4 w-4 ${physicsValidationComplete ? "text-blue-600" : "text-gray-600 dark:text-gray-400 dark:text-muted-foreground/70"}`} />
                  <div className="flex-1 min-w-0">
          ...
          <TooltipProvider>
            <Tooltip>
              <TooltipTrigger asChild>
                <div className="flex items-center gap-2 p-2 rounded-md bg-muted/50">
                  <DollarSign className={`h-4 w-4 ${costOptimisationApplied ? "text-purple-600" : "text-gray-600 dark:text-gray-400 dark:text-muted-foreground/70"}`} />
                  <div className="flex-1 min-w-0">
          ...
          <TooltipProvider>
            <Tooltip>
              <TooltipTrigger asChild>
                <div className="flex items-center gap-2 p-2 rounded-md bg-muted/50">
                  <Activity className={`h-4 w-4 ${governanceLoggingActive ? "text-teal-600" : "text-gray-600 dark:text-gray-400 dark:text-muted-foreground/70"}`} />
                  <div className="flex-1 min-w-0">
