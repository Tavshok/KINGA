...
|---|---|
| Portal and agency adapter convergence | Equivalent authorised payloads produce the same canonical claim and document shape in an isolated tenant fixture. |
