...
- [ ] Approved aggregate report migration: introduce a tenant-scoped ResolvedPlatformReportCollection and named aggregate helpers; migrate the Platform Executive Dashboard plus portfolio, fraud, and dwell-time reporting; retain SAR/privacy reporting unchanged pending explicit legal/compliance product approval; validate against live TiDB and open a review-only PR.
