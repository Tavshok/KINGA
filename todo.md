...
- [ ] R0 repairability evidence propagation: route explicit persisted structural-review evidence and rationale into CL, CI, FR, and client repairability verdicts so Further structural review required is available only when supported; do not infer it from cost or damage assumptions.
