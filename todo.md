...
- [ ] L2 savings report-presentation policy: Stage 9 retains `savingsL1vsL2Usd` for a complete warning-only provenance state, but the approved concise CL/CI/FR/client cost-decision sequence does not display a savings field. Present a separate controlled design decision before adding, qualifying, or testing a cross-surface savings display.
- [ ] Approved potential-savings presentation: display L1-minus-complete-L2 as “Potential verified saving from quotation optimisation” across CL, CI, FR, and client top-cost only when both values derive from eligible active submitted evidence; hide it for review-required, partial, no-active, and all-ineligible states without creating settlement authority.
- [ ] Read-only potential-savings HTML preview: prepare representative complete, no-saving, and human-review examples for user approval before changing report or client behaviour.
- [ ] User-confirmed client L2 disclosure: client surfaces must show only KINGA Optimised Quote and Potential savings, without calculation detail, benchmark formula, or “component optimisation” wording; describe L2 as KINGA’s broader evidence-led optimisation where explanation is necessary.
- [ ] Approved potential-savings presentation: display L1-minus-complete-L2 as “Potential verified saving from quotation optimisation” across CL, CI, FR, and client top-cost only when both values derive from eligible active submitted evidence; hide it for review-required, partial, no-active, and all-ineligible states without creating settlement authority.
