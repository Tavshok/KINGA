...
- [ ] Residual P0 claim/quote fallback audit: remove static tenant fallbacks from `claims-core.ts` and `quotes-core.ts` without weakening their existing claim object checks.
