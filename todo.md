...
- [ ] Residual P0 admin fixture authority: remove the administrative synthetic-claim tenant fallback and require the authenticated session tenant before any fixture creation.
