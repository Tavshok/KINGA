...
- [ ] R0 rendered-report acceptance: validate the combined submitted-quotation, quote-verification, KINGA Optimised Quote, repairability, quote-issue, and canonical photo-evidence presentation across CL, CI, and FR using immutable no-write evidence snapshots.
