...
- [ ] Priority tenant-role configuration publication: stage the reviewed service/test/report/backlog change, push the isolated branch, open a review-only PR, and record its URL/head commit. Do not merge or alter Gate C review branches.
