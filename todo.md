...
- [ ] AUD-P1 tenant administration user authority: tenant-scope pending registration list, deactivation, and role updates before any user record disclosure or mutation; retain authorised same-tenant administration without cross-tenant user management.
