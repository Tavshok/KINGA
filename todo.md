...
- [ ] D-03 execution authority: owner approves D-03 only and accepts a sole-operator/reviewer/application-validation-owner exception for Tavonga Shoko, scoped strictly to the pinned 50-table/26-FK/111-index Wave 3 ledger and expiring at D-03 closure, stop, abandonment, or approved-window expiry. Before any statement, collect fresh same-day snapshot evidence and exact read-only preflight confirming the 23 closed D-01/D-02 tables remain structurally unchanged and empty and that no D-03 table/FK/index exists. Execute only the 187 individual hash-verified ledger statements in ordinal order, stop on any mismatch or server error without blind retry, then independently verify 73 tables, all 26 D-03 FKs, all 111 D-03 indexes, and zero rows in every new table. No production action is authorised.
