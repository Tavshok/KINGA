...
- [ ] AUD-P1 AI assessment governance audit reads: apply the same tenant-owned claim precondition to audit-log/export validation, replay-log, and snapshot-history read helpers before declaring the wider AI assessment-governance surface fully closed.
