...
- [ ] PR #27 publication: commit and push the validated human-approval resolution, open or update the review-only pull request, and require its CI Vite build to be the authoritative production-build verification because the sandbox reaches a known chunk-rendering memory ceiling.
