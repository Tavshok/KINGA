...
- [ ] AUD-P0 claim-completion authority: require session-tenant claim resolution before complete or reopen workflow transitions; prevent foreign claim closure/reopening side effects.
- [ ] AUD-P0 approval decision authority: require session-tenant claim resolution before approval reads, comment insertion, approval decision, or audit workflow writes; prevent foreign claim approval mutations.
- [ ] AUD-P0 decision explanation authority: require session-tenant claim resolution and relevant role/ownership authority before claim explanation or routing reads; prevent foreign claim evidence disclosure.
