...
- [ ] Agency-assisted canonical runtime proof: add router/service-level regressions for same-tenant submission, foreign agency-client denial, foreign attachment denial, idempotent replay, and recoverable assessment-start failure on `createAgencyAssistedClaim`.
