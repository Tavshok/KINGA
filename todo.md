...
- [ ] AUD-P0 insurer payment mutation authority: require explicit tenant selection or same-tenant authority for payment-proof submission, payment verification, and payment rejection before any quote-status or policy-issuance side effect. Requires explicit approval because these operations can affect financial/policy workflow outcomes.
