...
- [ ] Report-tier updated-base contract resolution: retain only verified Claim PDF panel-beater and causal-verdict fields, remove duplicate incident description, preserve a durable record of intentionally omitted policy/forensic fields pending a real renderer consumer, then re-verify before updating the review branch.
