  ...
  json_schema: {
    ...
    schema: {
      ...
      properties: {
        ...
        airbagDeployment: { type: ["boolean", "null"], description: "Whether airbags deployed. Look for ANY of these in the claim form, assessor notes, or repair quote line items: 'airbag deployed', 'airbags deployed', 'airbags activated', 'airbag fired', 'SRS deployed', 'SRS activated', 'driver airbag', 'passenger airbag', 'curtain airbag', 'side airbag', 'air bag deployed', 'airbag replaced', 'airbag module', 'airbag inflator', 'airbag cover', 'airbag clock spring'. Also check the repair quotation for line items replacing airbag modules, covers, inflators, or clock springs — these confirm deployment even if not stated in the narrative. Return true if any evidence of deployment is found; false if explicitly stated as not deployed; null if not mentioned anywhere." },
        seatbeltPretensioner: { type: ["boolean", "null"], description: "Whether seatbelt pretensioners fired. Look for ANY of these: 'seatbelt pretensioner', 'belt pretensioner', 'belt tensioner', 'pretensioner deployed', 'pretensioner activated', 'pretensioner fired', 'SRS belt', 'belt lock', 'belt tensioner activated', 'pretensioner replaced', 'seatbelt assembly replaced', 'retractor replaced' in the claim form, assessor notes, or repair quote line items. Also check the repair quotation for line items replacing seatbelt assemblies, retractors, or pretensioner units — these confirm activation. Return true if any evidence of activation is found; false if explicitly stated as not activated; null if not mentioned anywhere." },
