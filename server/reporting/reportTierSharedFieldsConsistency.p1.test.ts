...
describe("report tier shared-field consistency", () => {
  ...
  it.each([
    ["unavailable", { isComplete: false, l2Status: "incomplete_scope", canonicalQuoteLedger: [] }, "Unavailable — active comparison evidence is incomplete; no L2 total, savings, or settlement value is shown."],
