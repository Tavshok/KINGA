...
const REPORT_CATALOGUE = [
  ...
  // ── Claims Intelligence & Forensic Decision (new tiers) ──────────────────────────
  ...
  { key: "claim.forensic_decision",          name: "Forensic Claim Decision Report",  category: "Claim Reports",  description: "Forensic-tier full reconstruction: physics, speed methods, damage zone map, fraud radar, 5-stage approval workflow.", requiresClaimId: true  },
  // ── Claims Manager ────────────────────────────────────────────────────────────────
