// @ts-nocheck
/**
 * KINGA Intelligence — Report Generator
 *
 * Design spec:
...
const PageFooter = ({ reportId, tier, page }: any) =>
  React.createElement(View, { style: body.pageFooter },
    React.createElement(Text, { style: body.pageFooterText }, `KINGA Intelligence  ·  ${tierLabel(tier)}  ·  Confidential`),
    ...
    React.createElement(View, { style: cover.inner },
      ...
      React.createElement(View, { style: cover.bottom },
        React.createElement(Text, { style: cover.disclaimer },
          'This report is generated by KINGA Intelligence and is confidential to the insurer and its authorised representatives. KINGA provides decision-support intelligence only. The insurer\'s designated reviewer validates all determinations.'
        ),
        React.createElement(View, null,
...
function ClaimsAssessmentReport({ data }: { data: any }) {
  ...
  return React.createElement(Document,
    { title: `KINGA Claims Assessment — ${claim?.claimNumber ?? reportId}`, author: 'KINGA Intelligence' },
    ...
    React.createElement(Page, { size: 'A4', style: body.page },
      ...
      React.createElement(View, { style: body.disclaimerBox },
        React.createElement(Text, { style: body.disclaimerText },
          `KINGA provides decision-support intelligence only. The insurer's designated reviewer validates all determinations. The insurer owns the conclusion. This report is generated under the KINGA platform and is confidential to the insurer and its authorised representatives. Report ID: ${fmt(reportId)}`
        )
      ),
...
function ClaimsManagerReport({ data }: { data: any }) {
  ...
  return React.createElement(Document,
    { title: `KINGA Claims Portfolio Report — ${tenantName ?? reportId}`, author: 'KINGA Intelligence' },
    ...
    React.createElement(Page, { size: 'A4', style: body.page },
      ...
      React.createElement(View, { style: body.disclaimerBox },
        React.createElement(Text, { style: body.disclaimerText },
          `KINGA provides decision-support intelligence only. This portfolio report is confidential to the insurer and its authorised representatives. Report ID: ${fmt(reportId)}`
        )
      ),
...
function RiskManagerReport({ data }: { data: any }) {
  ...
  return React.createElement(Document,
    { title: `KINGA Risk Portfolio Report — ${tenantName ?? reportId}`, author: 'KINGA Intelligence' },
    ...
    React.createElement(Page, { size: 'A4', style: body.page },
      ...
      React.createElement(View, { style: body.disclaimerBox },
        React.createElement(Text, { style: body.disclaimerText },
          `KINGA provides decision-support intelligence only. This risk portfolio report is confidential to the insurer and its authorised representatives. Report ID: ${fmt(reportId)}`
        )
      ),
...
function ExecutiveReport({ data }: { data: any }) {
  ...
  return React.createElement(Document,
    { title: `KINGA Executive Summary — ${tenantName ?? reportId}`, author: 'KINGA Intelligence' },
    ...
    React.createElement(Page, { size: 'A4', style: body.page },
      ...
      React.createElement(View, { style: body.blockquote },
        React.createElement(Text, { style: body.blockquoteText },
          `During the reporting period, ${tenantName ?? 'the insurer'} processed ${kpis.totalClaims?.value ?? '—'} claims through the KINGA Intelligence platform. ` +
      ...
      React.createElement(View, { style: body.disclaimerBox },
        React.createElement(Text, { style: body.disclaimerText },
          `KINGA provides decision-support intelligence only. This executive report is confidential to the insurer and its authorised representatives. Report ID: ${fmt(reportId)}`
        )
      ),
...
function AssessorPerformanceReport({ data }: { data: any }) {
  ...
  return React.createElement(Document,
    { title: `KINGA Assessor Performance Report — ${reportId}`, author: 'KINGA Intelligence' },
    ...
    React.createElement(Page, { size: 'A4', style: body.page },
      ...
      React.createElement(View, { style: body.disclaimerBox },
        React.createElement(Text, { style: body.disclaimerText },
          `KINGA provides decision-support intelligence only. This assessor performance report is confidential. Report ID: ${fmt(reportId)}`
        )
      ),
...
function ProcessorPerformanceReport({ data }: { data: any }) {
  ...
  return React.createElement(Document,
    { title: `KINGA Processor Performance Report — ${reportId}`, author: 'KINGA Intelligence' },
    ...
    React.createElement(Page, { size: 'A4', style: body.page },
      ...
      React.createElement(View, { style: body.disclaimerBox },
        React.createElement(Text, { style: body.disclaimerText },
          `KINGA provides decision-support intelligence only. Report ID: ${fmt(reportId)}`
        )
      ),
...
function PanelBeaterPerformanceReport({ data }: { data: any }) {
  ...
  return React.createElement(Document,
    { title: `KINGA Panel Beater Performance Report — ${reportId}`, author: 'KINGA Intelligence' },
