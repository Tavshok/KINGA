...
export type CanonicalClaimInput = {
  ...
  thirdPartyName?: string; thirdPartyVehicle?: string; thirdPartyRegistration?: string; thirdPartyInsurer?: string; policeReportNumber?: string; policeStation?: string; witnessName?: string; witnessPhone?: string;
